"""
Django settings for hornbill project.
...
SECRET_KEY = 'django-insecure-9wcd61+7kpls&i6aqro14+dp#&ftk8)s)49xe0e+6#3*-(y2ss'
...
WSGI_APPLICATION = 'hornbill.wsgi.application'
